...
This turns the full the subcategory of fibrant objects of $\catC$ into homotopical tribe.
\end{theorem}
...
\begin{theorem}[Gambino and Garner, Shulman]
...
Condition~(6') plays no role in the proof of the condition~(5) (the factorization).
