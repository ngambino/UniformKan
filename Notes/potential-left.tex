...
It seems that non-cartesian coherence for squares in $\cal{I}$ where the lower map is an epi encode regularity-like properties [reference later definition of regular Kan fibrations].
