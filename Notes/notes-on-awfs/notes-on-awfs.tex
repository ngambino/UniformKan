...
The inclusion $\overline{\cat{A}} \to \cat{A}$ induces a functor $\overline{\cat{A}}^{\pitchfork} \to \cat{A}^{\pitchfork}$ of categories over $\cat{E}^{\Box}$.
...
Analogously to \cref{retract-closure-extended-left}, the induced functor $^{\pitchfork}\overline{\cat{A}} \to{} ^{\pitchfork}\cat{A}$ of categories over $\cat{E}^{\Box}$ is an isomorphism.
\end{remark}
