...
\begin{corollary}
The cartesian fibration $Q$ in \cref{Alg-over-cod-pres-monad-is-cartesian-fib} has a right adjoint to base change along any map $d : A \to B$ in $\cat{E}$ such that $R$ preserves cartesian squares with bottom map $d$.
