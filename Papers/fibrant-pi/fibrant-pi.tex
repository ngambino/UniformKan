...
\begin{proposition}
The retract closure commutes with slicing and coslicing, in the sense that for every $u \co \cal{I} \to \cal{E}^\to$ we have
\[
...
\begin{proof}
First, observe that the full subcategory of $\cal{E}^\to$ spanned by monomorphisms with codomain a representable presheaf is small.
