...
We define a \emph{uniform trivial Kan fibration} \noten{Should these be called uniform trivial Cisinski fibrations?} to be a right $\cal{M}$-map. Note that  the compatibibility condition
...
\noten{Should the proof of this lemma be in an appendix?}
...
\noten{Should the proof of the lemma be in an appendix?}
