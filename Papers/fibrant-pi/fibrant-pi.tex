...
\begin{proof} This follows by \cref{strong-h-equiv-as-section-algebraic}.
\end{proof}
...
\rcyl \hatotimes \cal{I} \ar[dr] \ar[rr] & & \cal{S}_\ell(\cal{I}) \ar[dl] \\ 
 & \catE^\to & } \medskip
\end{equation}
These functors are defined explicitly in Appendix~\ref{app:two-functors}, the key step in proving the Frobenius property
