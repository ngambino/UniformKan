...
\[
\xymatrix@C+2em{
\cal{I}\text{-}\Fib_{/X} \ar[r] \ar[d]_{v/X} &  \overline{\cal{I}\text{-}\Fib}_{/Y} \ar[d]^{v/Y} \\ 
...
\]
 for $k \in \{0, 1\}$. 
For simplicity, we treat the case of $k =0$. Since a $\cal{I}$-fibration is in particular a $(\lcyl \otimes \id_\catE)$-right map,
