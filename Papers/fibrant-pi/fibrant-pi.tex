...
What we call a uniform Kan fibration in cubical sets does not seem to correspond to the notion of uniform Kan fibration defined in~\cite{coquand-variation} since their notion of $L$-system does capture all decidable subobjects of representables, omitting the ones not using connections.
%\notec{And which seems to have been a source of whay they call coherence issues, but what should properly be called failure of stability under pullback.}
Instead, it seems to be closer to the version of uniform Kan fibrations defined in terms of partial elements in~\cite{coquand-face,coquand-rules5}.
