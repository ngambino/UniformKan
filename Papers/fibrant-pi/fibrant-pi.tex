...
\]
then $F(\cal{I}) \subseteq \liftl{\cal{J}}$ if and only if $\cal{I} \subseteq G(\cal{J})$, and consequently $\liftr{F(\cal{I})} = G(\liftr{\cal{I}})$ and $\liftl{G(\cal{J})} = F(\liftl{\cal{J}})$.
