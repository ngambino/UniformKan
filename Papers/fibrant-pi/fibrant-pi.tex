...
This paper contributes to the ongoing efforts to define a constructive version of Voevodsky's simplicial model of univalent foundations~\cite{voevodsky-simplicial-model}. In particular, we focus on the question of whether it it is possible to prove constructively a counterpart of the statement that, in the category of simplicial sets, the pushforward functor (\ie the right adjoints to 
the pullback functor) along a Kan fibrations preserves Kan fibrations~\cite[Lemma 2.3.1]{voevodsky-simplicial-model}. 
Although this result follows from well-known facts of simplicial homotopy theory, it cannot be proved constructively without changes,  as shown in~\cite{coquand-non-constructivity-kan}. In order to improve on this situation, Bezem, Coquand and Huber are developing a new model of 
univalent foundation in the category of cubical, rather than simplicial, sets~\cite{coquand-cubical-sets}. In particular, they introduced the notion of a \emph{uniform Kan fibration} and shown that it is possible to prove a counterpart of the fact the pushforward functor along a Kan fibrations preserves Kan fibrations. 


These results may give the impression that there is something intrinsically non-constructive in simplicial homotopy theory. The work presented in this paper  shows that this impression is false and the possibility of eveloping a constructive version of Voevodsky's simplicial model remains open. Indeed,
...
by the theory of natural weak factorisation systems~\cite{grandis-tholen-nwfs} and algebraic weak factorisation systems~\cite{garner:small-object-argument}. In fact, we will work at a level of generality that allows us to obtain as a special case also the corresponding statement for cubical sets proved in~\cite{coquand-cubical-sets}.

\medskip


In order to motivate present our results more precisely, let us briefly recall the classical proof of the fact that the pushforward functor along a Kan fibration preserves Kan fibrations. First of all, recalling that Kan fibrations are the right class of a weak factorisation system in which the right class consists of the
trivial cofibrations (\ie maps of simplicial sets that are both weak equivalences and monomorphisms), the required statement is equivalent to showing that 
pullbacks along Kan fibrations preserves trivial cofibrations. This latter fact is then proved in two ways. One way is to combine the fact that the model structure on simplicial sets is right proper (\ie that pullbacks along Kan fibrations preserve weak equivalences) with the fact that pullbacks preserve monomorphisms.
...
We construct its image $(\intervalr \hatotimes i, \rho \hatotimes i)$ by tensoring the previous diagram with $\cal{I}(i)$, using that $\cal{I}$ is closed under tensoring with $\intervalr$:
\[
\xymatrix@C+2em{
...
We send it to the morphism $\intervalr \hatotimes \tau : (\intervalr \hatotimes i, \rho \hatotimes i) \to (\intervalr \hatotimes i', \rho \hatotimes i')$, again using that $\cal{I}$ is closed under tensoring with $\intervalr$: 
\[
\xymatrix@C+2em{
  \cal{I}(\intervalr \hatotimes i)
