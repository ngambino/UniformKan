...
In particular, working constructively we prove that in the category of simplicial sets the the pushforward along a uniform Kan fibration preserves uniform Kan fibrations.
...
It should be noted that a key fact for establishing both of our first and second main result is that uniform (trivial) fibrations can be be defined equivalently by weak orthogonality with respect to a small category of maps (\cref{small-gen-triv-kan}).
Working with uniform fibrations is essential to prove this fact, since it allows us to reduce an arbitrary lifting problem to a functorial family of lifting problems, while still working constructively.
