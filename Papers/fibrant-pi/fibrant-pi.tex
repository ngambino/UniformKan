...
have been obtained for cubical sets without connections in~\cite{coquand-cubical-sets,huber-thesis},
for cubical sets with connections  in ongoing work by Coquand and his collaborators (\cf \cite{coquand-variation}), and for a cartesian version of cubical sets in work in progress by Awodey~\cite{awodey-cubical}. Indeed, one of the initial motivations for this work was to investigate whether the methods used to obtain these results could be generalized to a more abstract setting so as to be applicable also to simplicial sets.
...
that is required in order to have a uniform fibration needs to satisfy an appropriate naturality condition.
...
conditions, which combines the Frobenius and Beck-Chevalley conditions in our setting. 
