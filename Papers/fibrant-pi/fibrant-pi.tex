...
The aim of this section is to show that, under suitable hypotheses, uniform fibrations satisfy the Frobenius condition, and in particular that uniform fibrations in presheaf categories always satisfy the Frobenius condition.
The proof of the main result in this section, \cref{uniform-fibrations-uniform-frobenius}, relies on two key steps, one following from our earlier results on strong homotopy equivalences and one on right orhogonality classes.
...
\[
  (\liftl{(\liftr{\cal{I}})})_{/X} \to \cal{J}_{//X}
\]
