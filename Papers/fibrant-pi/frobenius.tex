...
have been obtained for by Coquand and his collaborators for uniform fibrations in the category of cubical sets without connections in~\cite{coquand-cubical-sets,huber-thesis} and in some categories of cubical sets with connections (\cf \cite{coquand-face,coquand-variation,coquand-rules5}).
...
\cref{leibniz-lift} allows us to obtain an equivalent characterization of effective connections in terms of the functors $\delta^k \hatotimes (-)$ instead of $\delta^k \otimes (-)$ stated in \cref{effective-connections-leibniz}.
