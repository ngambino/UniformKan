...
By~\cref{thm:kcyl-of-cof-is-trivcof-non-alg}, we have that~$\kcylinv \hatotimes \bot_Y \in \TrivCof$, and hence have a diagonal filler since~$p \in \Fib$.
\end{proof}
...
the functor obtained by applying the Leibniz construction to the evaluation functor (\cf \cref{pitchfork-leibniz-most-general-applied} \notec{This reference does not make sense anymore; the notation $(-) \otimes (-)$ for functor application is currently nowhere defined}), the desired natural transformation
