...
It remains  \notec{Why?} to construct a pullback of categories  as follows:
\[
\xymatrix@C+3em{
  \liftr{\cal{I}}
...
\notec{Expand this, possibly including corollary in previous versions that is now omitted}
\end{proof}
