...
Let us now assume \notec{Reviewer suggests: replace ``now'' by ``for the remainder of this section''. But it is not just this section, it is all remaining sections except \cref{sec:ortf} and \cref{sec:frobc}.} that $\catE$ is equipped with a functorial cylinder $\interval\otimes (-) \co \catE \to \catE$ with contractions and connections, and that $\interval\otimes (-) \co \catE \to \catE$ has a right adjoint.
