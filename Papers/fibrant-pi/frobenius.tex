...
This problem was motivated by the question of whether the simplicial model of the extension of Martin-L\"of type theory~\cite{nordstrom-petersson-smith:ml} with Voevodsky's univalence axiom~\cite{voevodsky:univalence} can be developed constructively. For this, one needs to show that pushforward along Kan fibrations preserves Kan 
fibrations in order to interpret correctly the rules for $\Pi$-types~\cite[Lemma 2.3.1]{voevodsky-simplicial-model}. 
The independence result in~\cite{coquand-non-constructivity-kan} has been taken as an indication that a constructive development of the simplicial model is not possible and led to 
increased interest in models based on cubical sets~\cite{awodey-cubical,coquand-cubical-sets,cohen-et-al:cubicaltt,pitts-cubical-nominal,swan-awfs}.
