...
Let $P \co (\cal{E}^\to \downarrow \cal{E}) \times_{\cal{E}} \cal{E}^\to \to \cal{E}^\to$ denote base change of arrows over objects.
The structure of the uniform Frobenius condition of a functor $v \co \cal{J} \to \cal{E}^\to$ with respect to $u \co \cal{I} \to \cal{E}^\to$ is isomorphic to a lift of $P$ to a functor $Q \co (u \downarrow \cal{E}) \times_{\cal{E}} \cal{J} \to \liftl{(\liftr{\cal{I}})}$:
\[
\xymatrix{
  (u \downarrow \cal{E}) \times_{\cal{E}} \cal{J}
  \ar@{.>}[r]^-{Q}
  \ar[d]_{(u \downarrow \cal{E}) \times_{\cal{E}} v}
&
  \liftl{(\liftr{\cal{I}})}
  \ar[d]^{u}
\\
  (\cal{E}^\to \downarrow \cal{E}) \times_{\cal{E}} \cal{E}^\to
  \ar[r]_-{P}
&
  \cal{E}^\to
\rlap{.}}
