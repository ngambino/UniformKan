...
We say that $(\cal{I}, \cal{J}, \cal{K})$ satisfies the \emph{generalized uniform Frobenius condition} if pullback along $\cal{J}$-maps sends $\cal{I}$-maps to $\cal{K}$-maps, \ie the functor $Q$ admits a lift $\tilde{Q}$ as below:
...
We say that $(\cal{I}, \cal{J})$ satisfies the \emph{uniform Frobenius condition} if $(\cal{I}, \cal{J}, \liftl{(\liftr{\cal{I}})}, \cal{J})$ satisfies the generalized uniform Frobenius condition.
\end{definition}
...
Consider categories $u_t \co \cal{I} \to \cal{E}^\to$, $v_t \co \cal{I}' \to \cal{E}^\to$, $w \co \cal{J} \to \cal{E}^\to$ of arrows, for $t \in \braces{1, 2}$, related as follows:
\begin{align*}
\xymatrix@!C@C-1.5em{
  \cal{I}_2
  \ar[rr]^{F}
...
\rlap{.}}
\end{align*}
If $(\cal{I}_1, \cal{J}_1, \cal{K}_1)$ satisfies the uniform Frobenius condition, then so does $(\cal{I}_2, \cal{J}_2, \cal{K}_2)$.
\qed
\end{proposition}
...
Let $u \co \cal{I} \to \cal{E}^\to$ and $w \co \cal{K} \to \cal{E}^\to$ be functors such that $w$ reflects isomorphisms.
...
Then the following are equivalent:
\begin{enumerate}[(i)]
\item the triple $(\cal{I}, \cal{J}, \cal{K})$ satisfies the generalized uniform Frobenius condition,
...
Furthermore, this choice of $\tilde{Q}$ is forced upon us (up to isomorphism) by functoriality of $Q$ and the fact that $w$ reflects isomorphisms.
\end{proof}
...
\item $(\pcoalg{\LL}, \palg{\RR}, \pcoalg{\LL})$ satisfies the generalized uniform Frobenius condition.
...
Then $(\cal{I}, \cal{J}, \liftl{(\liftr{\cal{K}})})$ satisfies the generalized uniform Frobenius property if and only if the following hold:
\begin{enumerate}[(i)]
...
\begin{proof}
Since the functor $\liftl{(\liftr{w})}$ is faithful, a lift $\widetilde{v_j^*}$ consists just of a lift of the action of $v_j^*$ on objects that is coherent with respect to the action of $v_j^*$ on morphisms, in the sense that the action of $v_j^*$ on morphisms determines uniquely the action of its lift on morphisms.
...
Explicitly, it requires that $v_j^*(u_i) \co v_j^* X_i \to v_j^* Y_i$ is equipped with the structure of a left $\liftr{\cal{K}}$-map for $i \in \cal{I}$ and $u_i \co X_i \to Y_i$ over $D_j$, such that morphisms in $\cal{I}_{/D_j}$ induce morphisms of left $\liftr{\cal{K}}$-maps.
...
\item $(\liftl{(\liftr{I})}, \cal{J}, \liftl{(\liftr{I})})$ satisfies the generalized uniform Frobenius condition.
\end{enumerate}
\end{proposition}
...
\end{gathered}
\end{equation}
Using \cref{generalized-uniform-frob-nicer}, this corresponds to the generalized uniform Frobenius condition for $(\liftl{(\liftr{\cal{I}})}, \liftr{\cal{I}}, \liftl{(\liftr{\cal{I}})})$.
...
If $(\cal{I}_1, \cal{J}, \cal{K}_1,)$ and $(\cal{I}_2, \cal{J}_2, \cal{K}_2)$ satisfy the generalized uniform Frobenius property, then so do $(\cal{I}_1 \times_{\cal{E}^\to} \cal{I}_2, \cal{J}, \cal{K}_1 \times_{\cal{E}^\to} \cal{K}_2)$ and $(\cal{I}_1 +_{\cal{E}^\to} \cal{I}_2, \cal{J}, \cal{K}_1 +_{\cal{E}^\to} \cal{K}_2)$.
\end{proposition}
...
The triple $(\cal{S}, \Fib, \cal{S})$ satisfies the generalized uniform Frobenius condition.
\end{lemma}
...
The generalized uniform Frobenius condition for $(\Cof \times_{\cal{E}} \cal{S}_k, \Fib, \Cof \times_{\cal{E}} \cal{S}_k)$ then implies the uniform Frobenius condition for $(\Cyl, \liftr{\Cyl})$ using functoriality of generalized uniform Frobenius in the form of \cref{generalized-uniform-frob-functorial} with $F$ the functor $F$ in part~\eqref{thm:onedir} of~\cref{thm:strong-hequiv} and $H$ the functor $H$ in part~\eqref{thm:twodir} of~\cref{thm:strong-hequiv}.
