...
so that we can write $(-) \hatotimes (-) \co [\catE, \catE]^\to \times \catE^\to \to \catE^\to$ for the bifunctor
on categories of arrows induced by the Leibniz construction, defined in terms of pushouts.
