...
the Quillen model structure for Kan complexes. In cubical sets, it extends some 
work on cubical models of type theory by Coquand and others.
\end{abstract}
...
The main result in this paper  (\cref{frobenius-uniform-presheaf}) establishes the existence of algebraic weak factorization systems 
with the functorial Frobenius condition on presheaf categories equipped with a functorial cylinder. The right maps of these algebraic
