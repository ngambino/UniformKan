...
\rlap{.}}
\]
Writing $(-) \otimes (-) \co [\cal{E}, \cal{E}] \times \cal{E} \to \cal{E}$ as an infix shorthand for functor application, the Leibniz construction~\cite{riehl-verity:reedy} induces a functor $(-) \hatotimes (-) \co [\cal{E}, \cal{E}]^\to \times \cal{E}^\to \to \cal{E}^\to$ on the level of arrows.
