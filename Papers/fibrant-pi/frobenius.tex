...
The characterization of \cref{uniform-frob-nice} can be simplified even further under additional assumptions.
...
\end{equation}
is a morphism of Grothendieck fibrations.
Then the uniform Frobenius condition of $v \co \cal{J} \to \cal{E}^\to$ with respect to $u \co \cal{I} \to \cal{E}^\to$ is equivalent to a lift $Q'$ as below:
...
\cref{uniform-frob-even-nicer} applies if $\cal{J}$ is a category of right maps as in \cref{strong-h-equiv-uniform-base-change} or the category of algebras in an algebraic weak factorization system. We will now compare the uniform Frobenius condition with the functorial Frobenius condition of~\cite{garner:topological-simplicial}.
