...
\begin{proof} 
This is a diagram-chasing argument, which we outline in the case $k = 0$ (but see \cref{thm:kcylf-is-she-alg} for a structural proof).
...
%
%right endpoint of $\psi$: contractions:2.1
%right endpoint of $\phi$: contractions:2.1 and contractions
%
%left endpoint of $\psi$: contractions:1.1
%left endpoint of $\phi$: contractions:1.1 and contractions
\end{proof}
