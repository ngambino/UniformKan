...
The example discussed in~\cref{exa:composition-pullback-lift} below
will be used when the Beck-Chevalley conditions are introduced in~\cref{sec:frobc}.
...
Note that \cref{lift-of-adjunction} can be seen as a special case 
of \cref{lift-of-leibniz-adjunction} where $\cal{K}$ is the terminal category.
...
factorisation systems of the usual Frobenius condition~\cite{garner:types-omega-groupoids,gambino-garner:idtypewfs}. We conclude by relating
the uniform Frobenius condition to the functorial Frobenius condition 
of~\cite{garner:topological-simplicial}.
