...
\footnote{This assumption not used to instantiate our general results, but only for~\cref{partial-map-classifier,unif-vs-non-unif}.}
\end{enumerate}
...
$\cal{E}^\cart$ spanned by monomorphisms, written $\cal{M}$ below.
