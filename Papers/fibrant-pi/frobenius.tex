...
Let us point out that what we call a uniform Kan fibration in cubical sets does not correspond to the fibrant cubical types defined in~\cite{coquand-et-al:cubicaltt}: their notion of context restriction captures only the proper subset $\cal{M}'$ of decidable monomorphisms classified by their face lattice, excluding for example diagonals in cubes.
