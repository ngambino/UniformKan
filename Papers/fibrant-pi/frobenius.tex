...
\begin{theorem} \label{thm:onedir} There is a functor
\[
\xymatrix@!C@C-2.5em{
 \Fib{\cal{I}}
  \ar[dr]
  \ar@<4pt>[rr]^{\liftr{(L_0 + L_1)}} 
&&
...
\begin{proof} Combine the case $k = 0, 1$ of~\cref{lem:from-strong-hequiv} and pass
to the right orthogonality categories.  Note that the retract closure of \cref{lem:from-strong-hequiv} vanishes because of \cref{retract-closure}.
\end{proof} 


\subsection*{Connections} In order to obtain a functor in the other direction,
we make use of the additional assumptio of the presence of connections.
...
\begin{proof} Combining the cases $k = 0, 1$ of~\cref{lem:to-strong-hequiv} and pass
to the right orthogonality categories. 
\end{proof} 
...
\]
in~\cref{thm:onedir} and~\cref{thm:twodir}, relating uniform $I$-fibrations with right maps for strong homotopy equivalences relative to $\cal{I}$ are not, in general, inverses to each other in either way.
\end{remark}
