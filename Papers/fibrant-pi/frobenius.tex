...
Here, a uniform fibration is understood to be a map equipped with additional structure which provides diagonal fillers for appropriate diagrams, as in the theory of natural weak factorization 
systems~\cite{grandis-tholen-nwfs}, rather than a map for which these diagonal fillers are merely required to exist, as in the usual definition of a Kan fibration.
...
The fibrant cubical types defined in~\cite{cohen-et-al:cubicaltt} arise  by considering as uniform fibrations the right $\cal{M}'$-maps, where  $\cal{M}'$ is 
the full subcategory of $\cal{M}$ spanned by decidable monomorphisms classified by their face lattice, excluding for example diagonals in cubes. Since the presence of symmetries, diagonals, and connections precludes the cube category being Reedy, this may turn out to be a natural restriction. Note
that this choice $\cal{M}'$ also satisfies the properties~(i) to~(v) of \cref{uniform-fib-presheaf-cat} and is thus covered by our development. \end{example}
