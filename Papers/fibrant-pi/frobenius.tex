...
factorisation systems are a variant of standard weak factorisation systems~\cite{bousfield-wfs}
...
higher-dimensional category theory~\cite{garner:globular-operator-awfs,batanin-cisinski-weber} but also in Voevodsky's univalent foundations programme~\cite{voevodsky:uf},  via the seminal work of  Bezem, Coquand, and Huber on uniform Kan fibration in categories of cubical sets~\cite{coquand-cubical-sets},
...
which can be understood as counterparts of some important results of Cisinski's theory~\cite{cisinski-asterisque}. We  apply these results  to solve an open problem in univalent foundations, namely that of proving a constructive counterpart of the
