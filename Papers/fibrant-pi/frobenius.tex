...
higher-dimensional category theory~\cite{batanin-cisinski-weber} but also in Voevodsky's univalent foundations programme~\cite{voevodsky:uf},  via the seminal work of  Bezem, Coquand, and Huber on uniform Kan fibration in categories of cubical sets~\cite{coquand-cubical-sets},
...
Finally, let us remark that it is possible to prove the right properness by avoiding  the algebraic approach adopted in 
...
equivalences (\cf~\cref{relating-strong-hequiv-and-uniform-fib}).
\end{remark}
