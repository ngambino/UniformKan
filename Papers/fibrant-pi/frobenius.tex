...
\begin{proof}
Condition~(i) is equivalent to coherence of lifts
\[
\xymatrix{
  F_1 A
  \ar[d]_{u_{F_1 i}}
...
\]
for $i \in \cal{I}$ and $j \in \cal{J}$.
Similarly, condition~(ii) is equivalent to coherence of lifts
\[
\xymatrix{
  A
  \ar[d]_{u_i}
...
\]
for $i \in \cal{I}$ and $j \in \cal{J}$.
By adjointness, these situations are equivalent.
\end{proof}
...
In analogy with \cref{lift-dependent-product}, we provide a consequence of the Beck-Chevalley condition of \cref{def:beck-chevalley} in terms of pushforward functors.
...
\begin{proof}
Apply \cref{lift-of-mates} to the adjunctions $g^* t_! \dashv t^* g_*$ and $s_! f^* \dashv g^* t_!$.
\end{proof}
