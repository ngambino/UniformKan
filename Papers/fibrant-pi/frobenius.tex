...
\begin{proof}
This is a diagram-chasing argument, similar to the one in \cref{thm:endpoint-are-she}, which we omit for brevity (but see \cref{thm:kcylf-is-she-alg} for a systematic proof).
\end{proof}
