...
The role of elegancy is to allow us to factor any map in $\cal{M}$ into a series of cobase changes of boundary inclusions, allowing us to decompose lifting problems for uniform trivial $\cal{M}$-fibrations into lifting problems for trivial fibration.
...
Note that the category $\cal{J}$ in the above definition has been chosen such that regular trivial fibrations consist of lifting structures against boundary inclusions given by degenerate elements whenever they constitute a lift.
