...
For future reference, we make explicit the inherent functoriality of the parameters $u \co \cal{I} \to \cal{E}^\to$ and $v \co \cal{J} \to \cal{E}^\to$ in the following two propositions.

We now state functoriality for future use.
