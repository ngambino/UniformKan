...
Let $P \co \cal{E}^\to_{/-} \times_{\cal{E}} \cal{E}^\to \to \cal{E}^\to$ denote base change of arrows over objects where the pullback is with respect to the slicing information of $\cal{E}^\to_{/-}$ and the codomain part of $\cal{E}^\to$.
The structure of the uniform Frobenius condition of a functor $v \co \cal{J} \to \cal{E}^\to$ with respect to $u \co \cal{I} \to \cal{E}^\to$ is isomorphic to a lift of $P$ to a functor $Q \co \cal{I}_{/-} \times_{\cal{E}} \cal{J} \to \liftl{(\liftr{\cal{I}})}$:
\[
\xymatrix{
