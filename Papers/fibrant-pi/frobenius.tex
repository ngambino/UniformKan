...
since it is analogous to the well-known Beck-Chevalley conditions~\cite{benabou-descente,lawvere-equality}.  Hence, as part of our development, we will introduce a single
 ...
 appropriate counterpart for algebraic weak factorisation systems of the usual condition. The uniform Frobenius condition introduced here is similar to the functorial Frobenius condition of~\cite{garner:topological-simplicial}, but formulated in a slightly more general setting.
...
\notec{
Can you clarify the last two sentences?
What is a weak algebraic factorisation system?
As far as I can see, \cite{garner:types-omega-groupoids} does not talk about any kind of factorization systems (though it does call Frobenius a pullback stability property in a weaker setting).
Is it really an appropriate reference for Frobenius in weak factorization systems?
}
