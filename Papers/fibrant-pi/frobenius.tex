...
It suffices to lift the components of $\phi$ without regard for further coherence.
They will then form a natural transformation since $\liftl{(\liftr{u})} \co \liftl{(\liftr{\cal{I}})} \to \cal{E}^\to$ is faithful.
\end{remark}
...
he structure of the uniform Frobenius condition of $v \co \cal{J} \to \cal{E}^\to$ with respect to $u \co \cal{I} \to \cal{E}^\to$ is equivalent to a lift of $P$ to a functor $Q'$ as below:
...
Furthermore, this choice of $Q$ is up to isomorphism forced upon us by functoriality of $Q$ and the fact that $\liftl{(\liftr{u})}$ reflects isomorphisms.
\end{proof}
...
Combine the premise with \cref{strong-h-equiv-uniform-base-change} using \cref{uniform-frobenius-product-u}, recalling the definition~\eqref{rel-strong-h-equiv-def} of $S_k(\cal{I})$ as a strict pullback of categories.
\end{proof}
