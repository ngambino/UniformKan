...
In recent years, there has been increasing interest in the study of algebraic counterparts of the notions of a weak factorisation system~\cite{bouke-garner-I,bourke-garner-II,grandis-tholen-nwfs,garner:small-object-argument} and of a Quillen model category~\cite{riehl-algmodel-cat,riehl-cat-homotopy}. Here, the focus is on maps equipped with additional structure which provides diagonal fillers for appropriate diagrams, rather than on maps for which these diagonal fillers are merely required to exist.  This research has found applications in Voevodsky's univalence foundations programme~\cite{voevodsky:uf}, beginning with the work of Bezem, Coquand, and Huber~\cite{coquand-cubical-sets}, who studied uniform Kan fibration in categories of cubical sets~\cite{awodey-cubical,cohen-et-al:cubicaltt,huber-thesis,pitts-cubical-nominal,swan-awfs}.


Our aim here is to contribute to this development of algebraic homotopy theory 
by introducing the uniform Frobenius condition, introducing uniform fibrations in presheaf categories, and establishing that, under mild assumptions, uniform fibrations are the right maps of algebraic weak factorisation systems that satisfy the uniform Frobenius condition. As
a special case of our results, we obtain that in the category of simplicial sets pushforward along a uniform Kan fibration preserves uniform Kan fibrations, providing a solution to
the open problem of giving a constructive counterpart of the fact that pushforward along a Kan fibration preserves Kan fibrations, which is a key ingredient of the simplicial model of univalent foundations~\cite[Lemma~2.3.1]{voevodsky-simplicial-model} but cannot be proved constructively without modifying the standard notion of a Kan fibration~\cite{coquand-non-constructivity-kan}. Our general result subsumes analogous results have been obtained by Coquand and his collaborators for uniform fibrations in a category of cubical sets with connections (\cf \cite{cohen-et-al:cubicaltt}).
