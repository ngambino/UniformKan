...
Note however, following the footnote in \cref{exa-triv-kan-fib}, that our results still apply to such $\cal{N}'$ under the assumptions that $\cal{N}'$ is closed under base change along morphisms between representables and Leibniz tensor with endpoint inclusions.
\end{example}
