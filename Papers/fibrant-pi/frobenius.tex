...
\begin{proof}
First observe that there are functors over $\cal{E}^\to$ back and forth between $\pcoalg{\LL} = \liftl{(\liftr{\cal{I}})}$.
%
...
This follows from \cref{uniform-frobenius-product-u} since $(\Cof, \CofFib, \Cof)$ satisfies the uniform Frobenius condition by 
