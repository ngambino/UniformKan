...
The most natural way to state the uniform Frobenius condition, making superfluous the need to separately state the Beck-Chevalley condition, is given by the following proposition.
