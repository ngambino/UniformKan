...
A standard diagram-chasing argument using~\eqref{contractions}, \eqref{connections:0}, \eqref{connections:1} verifies that $\phi$ and $\psi$ have the correct endpoints and that the $0$-oriented homotopy equivalence $(f, g, \phi, \psi)$ is strong using diagrams.
%
