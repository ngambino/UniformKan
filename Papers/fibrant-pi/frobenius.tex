...
Our first main result (\cref{thm:sset-cset-nwfs}) is that, in presheaf categories satisfying a suitable presentability assumption\footnote{We use a finite presentability condition to be able to work constructively. A more general result holds classically, see~\cref{sec:unifpc} for more details.}, uniform trivial fibrations and uniform fibrations are the right maps of two natural weak factorization systems.
...
considered a further example of the good interaction between colimits and lifting problems in the theory of natural weak factorization systems that was already noted in~\cite{riehl-cat-homotopy}.
...
We are interested in algebraic counterparts of the weak orthogonality properties that are used in the definition of a weak factorization system~\cite{bousfield-wfs} as considered in the theory of natural weak factorization systems~\cite{grandis-tholen-nwfs}.
