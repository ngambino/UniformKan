...
\begin{proof} By the Yoneda lemma and the universal property of pullbacks, it suffices to show that diagrams of the form
\[
\begin{gathered}
\xymatrix@C+2em{
...
\end{gathered}
\]
are in natural bijective correspondence with diagrams as in item (ii) of~\cref{lift-of-leibniz-adjunction}. But the former
are in natural bijective correspondence with diagrams as in  item (i) of~\cref{lift-of-leibniz-adjunction}  by the adjunction~\eqref{garner-adjunction}.
\end{proof} 
...
Fix categories $\catE$ and $\catF$ and let $\Adj(\catE, \catF)$ be the category of adjunctions $U \dashv V$ with $U \co \catE \to \cal{F}$ and $V \co \cal{F} \to \catE$ and maps of adjunctions~\cite[Chapter IV,\S 7]{MacLaneS:catwm}. We then have 
functors
\[
...
\\
  \catE^\to
  \ar[r]_-{\widehat{\eval}_L(\alpha, \arghole)}
&
  \cal{F}^\to
\rlap{,}} 
\end{gathered}
...
\\
  \cal{F}^\to
  \ar[r]_-{\widehat{\eval}_R(\bar{\alpha}, \arghole)}
&
  \catE^\to
\rlap{.}}
\end{gathered}
...
\xymatrix@C=1.5cm{
  \liftr{\cal{I}}
  \ar[r]
  \ar[d]_{\liftr{(\widehat{\eval}_L(\alpha, \arghole) \cc u)}}
  \pullback{dr}
&
  \liftr{\cal{I}}
  \ar[d]^{\liftr{u}}
...
We now give the algebraic analogue of \cref{thm:char-fib-nonalg}, \ie an equivalent characterization of uniform fibrations which does not refer to generating uniform cofibrations. This will show that the categories $\Fib$ and $\TrivCof$ are independent of the choice of the cofibrant generator $\cal{I}$ of $(\CC, \TF)$. We need some preliminary remarks.
\notec{TO BE ADDED.}
...
The statement then follows from \cref{pitchfork-leibniz-most-general-example}.
\end{proof}
