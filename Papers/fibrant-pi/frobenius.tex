...
We define a second set of maps $\cal{I}_\otimes \defeq (\lcyl \hatotimes \cal{I}) \cup (\rcyl \hatotimes \cal{I})$ in $\cal{E}$, called the \emph{generating trivial cofibrations.} It generates a weak factorization system $(\cal{TC}, \cal{F})$, whose left and right classes we respectively call \emph{trivial cofibrations} and \emph{fibrations}.

\notec{Add assumptions on $\cal{C}$ --- every object cofibrant, closure under pushout product with endpoint inclusions, etc.}
