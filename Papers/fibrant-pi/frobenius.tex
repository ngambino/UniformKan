...
aspects (such as the failure of left and right maps to be closed under all colimits), which can be
remedied by considering instead algebraic weak factorisation  systems~\cite{bourke-garner-I,bourke-garner-II,garner:small-object-argument,grandis-tholen-nwfs,riehl-cat-homotopy}. This is  due to the fact that algebraic weak factorisation systems 
involve maps equipped with a suitably natural
family of solutions for lifting problems, rather than maps merely satisfying
a lifting property. Remarkably, the presence of this additional algebraic structure on maps has proved to be crucial also for the applications of algebraic weak factorization systems in
