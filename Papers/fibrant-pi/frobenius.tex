...
Note that the category $\cal{J}$ in the above definition has been chosen such that a regular trivial fibration is a map equipped with a filler for each boundary inclusion lifting problems such that degenerate lifting problems have degenerate fillers.
